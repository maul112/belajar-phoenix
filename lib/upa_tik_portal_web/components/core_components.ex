defmodule UpaTikPortalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(UpaTikPortalWeb.Gettext, "errors", msg, msg, count, opts)
    # else
  ...
  attr :rest, :global,
    ...
    doc: "the arbitrary HTML attributes to add to the form tag"
  ...
  JS commands can be passed to the `on_cancel` prop to customize
